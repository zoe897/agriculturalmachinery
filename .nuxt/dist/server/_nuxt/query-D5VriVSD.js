...
import { b as useNuxtApp, c as asyncDataDefaults, d as createError, u as useRuntimeConfig, e as useRequestEvent } from "../server.mjs";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-dRkIds2U.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-D5VriVSD.js.map
