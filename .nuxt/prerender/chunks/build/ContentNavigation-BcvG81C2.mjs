import { defineComponent, useSlots, toRefs, computed, h, useSSRContext } from 'file:///workspaces/agriculturalmachinery/node_modules/vue/index.mjs';
import { hash } from 'file:///workspaces/agriculturalmachinery/node_modules/ohash/dist/index.mjs';
import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-D5VriVSD.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-dRkIds2U.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-BcvG81C2.mjs.map
