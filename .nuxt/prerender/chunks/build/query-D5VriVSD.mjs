import { ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref } from 'file:///workspaces/agriculturalmachinery/node_modules/vue/index.mjs';
import { b as useNuxtApp, c as asyncDataDefaults, u as useRuntimeConfig, e as useRequestEvent, d as createError } from './server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase } from 'file:///workspaces/agriculturalmachinery/node_modules/ufo/dist/index.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-dRkIds2U.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-D5VriVSD.mjs.map
