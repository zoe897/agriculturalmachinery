declare global {
  ...
  const generateWhatsAppLink: typeof import('../../server/utils/whatsapp').generateWhatsAppLink
  ...
  const saveToSheet: typeof import('../../server/utils/googleSheet').saveToSheet
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/workspaces/agriculturalmachinery/node_modules/nuxt/dist/core/runtime/nitro/paths';
export { defineAppConfig } from '/workspaces/agriculturalmachinery/node_modules/nuxt/dist/core/runtime/nitro/config';
export { parseMarkdown } from '/workspaces/agriculturalmachinery/node_modules/@nuxtjs/mdc/dist/runtime/parser';
export { useImage } from '/workspaces/agriculturalmachinery/node_modules/@nuxt/image/dist/runtime/server/utils/image';
export { sendEmail } from '/workspaces/agriculturalmachinery/server/utils/email';
export { saveToSheet } from '/workspaces/agriculturalmachinery/server/utils/googleSheet';
export { generateWhatsAppLink } from '/workspaces/agriculturalmachinery/server/utils/whatsapp';